...
class DealServiceTest {
    ...
    void setUp() {
        ...
        // Sample Users
        currentUser = new User(1L, "currentUser", "current@user.com", "password", null, true, LocalDateTime.now(), null, null);
        assignedUser = new User(2L, "assignedUser", "assigned@user.com", "password", null, true, LocalDateTime.now(), null, null);
    }

    @Test
    void testCreateDeal_Success() {
        CreateDealDTO dto = new CreateDealDTO("Client A", DealType.M_A, "IT", DealStage.PROSPECT, "Summary", 2L);
    ...
    void testGetDealById_DealNotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> dealService.getDealById(1L));
    }

    @Test
    void testUpdateDeal_Success() {
        CreateDealDTO dto = new CreateDealDTO("Client B", DealType.EQUITY_FINANCING, "Finance", DealStage.PROSPECT, "Updated Summary", 2L);
    ...
    void testAddNote_Success() {
        ...
        assertEquals(currentUser.getUsername(), result.getNotes().get(0).getUser().getUsername());
    }
    ...
    void testDeleteDeal_NotFound() {
        ...
        assertThrows(ResourceNotFoundException.class, () -> dealService.deleteDeal(1L));
    }
}
